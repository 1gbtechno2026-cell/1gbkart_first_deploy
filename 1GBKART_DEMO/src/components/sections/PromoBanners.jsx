    ...
    <section className="grid sm:grid-cols-2 gap-4 py-2">
      {banners.map((b, i) => (
        <motion.div
          ...
          className={`relative bg-gradient-to-br ${b.bg} rounded-3xl p-7 overflow-hidden cursor-pointer group`}
        >
          <div className="relative z-10">
            ...
            <button className="px-5 py-2 bg-white text-slate-900 font-bold text-sm rounded-xl hover:bg-white/90 transition-colors">
              {b.cta} →
            </button>
          </div>
          <div className="absolute right-6 top-1/2 -translate-y-1/2 text-7xl select-none"
